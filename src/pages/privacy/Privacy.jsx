...
const Privacy = () => {
  return (
    <>
    <BreadCrumb title="Privacy Policy" desc="At Sara Electrical, our mission is to empower individuals, businesses, and communities through excellence." img="/images/Rectangle 605.svg"/>
    ...
    <section className='privacy'>
        <div className="container">
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <Link to="https://www.termsfeed.com/privacy-policy-generator/">Privacy Policy Generator.</Link>  </p>
            ...
            <ul>
              ...
              <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Sara Electrical, Head Office – Abu Dhabi.</li>
              ...
              <li>Website refers to Sara Electrical, accessible from SaraElectrical.ae</li>
            ...
            <ul>
              <li><b>Necessary / Essential CookiesType:</b> Session CookiesAdministered by: UsPurpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</li>
              <li><b>Cookies Policy / Notice Acceptance CookiesType:</b> Persistent CookiesAdministered by: UsPurpose: These Cookies identify if users have accepted the use of cookies on the Website.</li>
              <li><b>Functionality CookiesType:</b> Persistent CookiesAdministered by: UsPurpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</li>
            </ul>
            ...
            <h5>Security of Your Personal Data</h5>
              ...
              <ul>
                <li style={{display: "flex", alignItems: "center"}}>By email:  <a href={`mailto:Support@SaraElectrical.ae`}>
                    <p>Support@SaraElectrical.ae</p>
                </a></li>
              </ul>
        </div>
    </section>
